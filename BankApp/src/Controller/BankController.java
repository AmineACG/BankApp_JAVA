...
//@AMINEACG
    ...
    public PersonAccountDAO getPersonAccountDAO() {
        return personAccountDAO;
    }

    public void setPersonAccountDAO(PersonAccountDAO personAccountDAO) {
        this.personAccountDAO = personAccountDAO;
    }

    public BankAppGUI getBankAppGUI() {
        return bankAppGUI;
    }

    public void setBankAppGUI(BankAppGUI bankAppGUI) {
        this.bankAppGUI = bankAppGUI;
    }
